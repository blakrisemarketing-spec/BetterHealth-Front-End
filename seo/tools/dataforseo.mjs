...
// login. Output is JSON on stdout for the nightly routine to parse.
//
// Usage:
//   node seo/tools/dataforseo.mjs serp   "what is HbA1c"          # live Google SERP (Ghana)
//   node seo/tools/dataforseo.mjs volume "blood test,hba1c test"  # monthly search volume
//   node seo/tools/dataforseo.mjs ideas  "health screening"       # related keyword ideas
//
// Location defaults to Ghana (location_code 2288), language English. Override with
// DFS_LOCATION_CODE / DFS_LANGUAGE_CODE env vars.
