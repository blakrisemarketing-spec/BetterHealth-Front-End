          ...
          <div className="max-w-[1280px] mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <Reveal>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="#notify"
                  className="flex items-center gap-3 px-5 py-3 rounded-xl bg-white/10 border border-white/20 text-gray-300 font-semibold text-sm hover:bg-white/20 hover:text-white transition-colors"
                >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {FEATURES.map((f, i) => (
                <Reveal key={f.title} delay={i * 0.07}>
                  <div className="p-6 rounded-2xl border border-border bg-white hover:shadow-md transition-shadow">
          ...
          <div className="max-w-[560px] mx-auto text-center">
            <Reveal>
              ...
              >
                ...
                <button
                  type="submit"
                  className="px-6 py-3 rounded-xl bg-primary text-white font-semibold text-sm hover:bg-primary-dark transition-colors whitespace-nowrap"
                >
                  Notify me
                </button>
              </form>
