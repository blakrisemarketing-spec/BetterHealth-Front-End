            ...
            <Reveal delay={0.1}>
              <div className="grid grid-cols-1 gap-3">
                {problem.stats.map((stat, i) => (
                  <div key={i} className="bg-white border border-border rounded-card px-5 py-4 flex items-center gap-4">
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
            {partners.items.map((p, i) => (
              <Reveal key={i} delay={i * 0.08}>
                <div className="bg-white border border-border rounded-card p-6 hover:-translate-y-1 transition-all duration-300 hover:shadow-card">
          ...
          <div className="flex flex-col gap-3 mb-8">
            {roadmap.milestones.map((m, i) => (
              <Reveal key={i} delay={i * 0.05}>
                <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-card px-5 py-3.5">
