...
export const testimonials = [
  ...
  { name: "Kwame M.", age: 28, location: "Kumasi", quote: "I\u2019d been blaming my job for a year. The actual reason cost twenty cedis to test. I think about that a lot.", discovery: "Vitamin D deficiency" },
...
export const storiesPage = {
  ...
  stories: [
    ...
    },
    {
      ...
      age: 28,
      city: "Kumasi",
      headline: "“I thought it was the job. It was sunlight.”",
      narrative: [
        "Kwame is 28, writes code for a fintech in Kumasi, and works from a flat where the curtains stay closed most of the day because the glare on his monitor is brutal. He’d been tired for about eighteen months — not exhausted, just flat. His muscles ached after workouts that used to feel easy. He’d lost interest in the gym.",
        "He blamed deadlines. Then he blamed his pillow. Then he bought a third monitor and blamed his posture. “Honestly, I thought I was just getting older,” he says, which, at 28, he laughs about now. His girlfriend told him to see someone. He said he’d go after the next release. He didn’t.",
        "What pushed him was a work medical — his company started offering BetterHealth as part of their benefits. He signed up because it was free, not because he expected anything to come of it. His Vitamin D came back at 11 ng/mL. The dashboard wrote out, in plain English, that this was severely deficient and could cause exactly the symptoms he’d been ignoring.",
        "His ferritin was also low — 18 ng/mL. Not anaemic yet, but his iron stores were running on empty. “I live in Kumasi. It’s literally sunny eleven months a year. How could I be Vitamin D deficient?” The dashboard explained: you need direct sun on bare skin, and he was getting maybe twenty minutes a day, mostly walking to and from his car.",
        "Kwame started on Vitamin D and iron supplements. He admits he forgot to take them about a third of the time in the first month. He moved his desk closer to the window and bought blackout shades instead. After about ten weeks his Vitamin D was at 31 ng/mL — just into the optimal range — and the brain fog had visibly lifted. He’s still on supplements. He still forgets sometimes.",
      ],
      numbers: [
        { label: "Vitamin D (25-OH)", before: "11 ng/mL", after: "31 ng/mL", status: "severely deficient → optimal" },
        { label: "Ferritin", before: "18 ng/mL", after: "44 ng/mL", status: "depleted → healthy" },
        { label: "Haemoglobin", before: "13.2 g/dL", after: null, status: "normal — wouldn’t flag on a standard CBC" },
      ],
      quote: "“I’d been blaming my job for a year. The actual reason cost twenty cedis to test. I think about that a lot.”",
    },
    {
    ...
    },
    {
      ...
      narrative: [
        "Akua is 36, sells fabrics at Madina market, and had been buying antacids in bulk for nearly five years. She’d see a doctor once a year, sometimes less. They’d press on her stomach, ask about stress, prescribe omeprazole. It would work for a few weeks, then the burning would come back.",
