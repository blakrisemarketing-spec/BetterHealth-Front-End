  ...
  values: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Comprehensive health screening shouldn\u2019t cost GHS 6,250 and require a referral. We\u2019ve built a platform that makes world-class lab testing accessible to every Ghanaian \u2014 not just the privileged few.",
      },
    ],
  },
  howWeWork: {
...
export const pricingPage = {
  ...
  valueAnchor: "A comprehensive health screen at a private hospital in Accra costs between GHS 2,970 and GHS 6,250 - if they even offer all the tests. BetterHealth starts at GHS 2 per day.",
  plans: [
    {
      name: "Essential",
      ...
      includes: [
        ...
        "1 comprehensive screening per year",
      ...
      excludes: [
        "Home collection (available as add-on)",
        "Doctor consultation (available as add-on)",
      ],
