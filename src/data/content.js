...
export const howItWorksPage = {
  ...
  steps: [
    {
      ...
      body: "Create your BetterHealth account with your email or phone number. Tell us a few basics — age, sex, and any health concerns you'd like to focus on. Then choose the plan that fits your needs.",
      expects: [
        ...
        "You'll receive a confirmation email and SMS immediately",
      ],
    },
    {
      num: "02",
      heading: "Choose how and where you test",
      body: "You decide what works for you. Visit one of our accredited partner labs across Ghana, or book home collection and a certified phlebotomist comes to your door. Either way, the blood draw takes about 10 minutes.",
      expects: [
        "In-lab option: Walk into any BetterHealth partner lab during opening hours. No appointment needed for Essential plans.",
        "Home collection: Pick a date and time that works for you. Our phlebotomist arrives within a 30-minute window.",
        "You'll receive an SMS confirmation with your collector's name and expected arrival time",
        "The blood draw itself takes 5–10 minutes",
        "Fasting required for some tests — we'll tell you exactly which ones when you book",
      ],
      subSection: {
        ...
        details: [
          ...
          "Home collection is included free with Complete and Premium plans",
          "Available as a GHS 50 add-on for Essential plan members",
        ],
      },
    },
    {
      ...
      expects: [
        ...
        "You'll receive an SMS and email notification the moment your results are ready",
      ...
      subSection: {
        ...
        body: "Most lab reports give you a wall of numbers and abbreviations. BetterHealth translates every result into something you can actually understand and act on. Here's what you'll see:",
        details: [
  ...
  safetyCards: [
    { icon: "FlaskConical", title: "Accredited Partner Labs", body: "Every sample is processed at labs that meet Ghana Health Service standards. We don't run our own labs — we partner with established, accredited facilities so you get the same quality as a hospital without the hospital experience." },
  ...
  faqs: [
    { q: "Do I need to fast before my blood test?", a: "Some biomarkers require fasting (no food or drink except water for 8–12 hours before collection). When you book your collection, we'll tell you exactly which tests require fasting and give you clear preparation instructions via SMS." },
    { q: "How much blood is taken?", a: "A comprehensive panel typically requires 3–5 tubes of blood, totalling about 15–25 mL. That's roughly 1–2 tablespoons. Most people feel no effects afterward." },
    { q: "What if I'm afraid of needles?", a: "Our phlebotomists are experienced and gentle — many patients tell us it's the most comfortable blood draw they've had. If you're particularly anxious, let us know when you book and we'll pair you with a collector experienced in working with needle-shy patients." },
...
export const whatWeTestPage = {
  hero: {
    ...
    cta: "Start Testing",
    intro: "Below you'll find every body system we test, why it matters for your health, and the specific biomarkers included. Each plan covers a different depth — see the plan comparison at the bottom to understand which markers are included in your package.",
  },
  systems: [
    {
      icon: "Heart",
      ...
      count: 12,
      why: "Heart disease is the leading cause of death in Ghana — and it's almost entirely preventable when caught early. Most people don't know their cardiovascular risk until they're in a hospital bed. These 12 markers give you the complete picture of your heart health, far beyond the basic cholesterol test you might get at a hospital.",
      markers: [
        ...
        { name: "ApoB", note: "the single best predictor of heart attack risk (most hospitals don't test this)" },
        { name: "Lp(a)", note: "a genetic risk marker that doesn't change with diet or exercise" },
    ...
    },
    {
      ...
      callout: "High blood pressure — affecting 1 in 3 Ghanaian adults — is the leading cause of kidney disease. If you have hypertension, regular kidney monitoring isn't optional. It's essential.",
    },
    {
      icon: "Gauge",
    ...
    },
    {
      ...
      name: "Hormones",
      count: 10,
      why: "Hormones regulate energy, mood, sleep, weight, fertility, and muscle mass. Imbalances cause fatigue, weight changes, low mood, hair loss, irregular periods, reduced libido, and dozens of other symptoms that are frequently dismissed as 'just stress.' A full hormone panel reveals what's actually happening inside — and whether your symptoms have a treatable cause.",
      markers: [
    ...
    },
    {
      ...
      callout: "Ferritin can be critically low even when your haemoglobin (the standard anaemia test) is normal. If you've been told 'you're not anaemic' but still feel exhausted, ferritin is the test that reveals the real picture.",
    },
    {
      icon: "Droplet",
      name: "Blood Health",
      ...
      callout: "Approximately 1 in 4 Ghanaians carries the sickle cell trait. Most don't know. If two carriers have children together, each child has a 25% chance of sickle cell disease. Knowing your status is one of the most impactful health decisions you can make.",
    },
    {
      icon: "Radio",
      name: "Thyroid",
      ...
      markers: [
        { name: "TSH", note: "the first-line screening test; but it's not enough on its own" },
...
export const aboutPage = {
  ...
  problem: {
    ...
    body: [
      "In Ghana, most people only see a doctor when something is already wrong. A headache that won\u2019t go away. Unexplained weight loss. Fatigue that doesn\u2019t lift. By then, conditions that were treatable have often progressed. Prevention isn\u2019t part of the culture \u2014 not because Africans don\u2019t value their health, but because the infrastructure for proactive screening barely exists.",
      "Comprehensive health screening has been a privilege reserved for the wealthy few who can afford private hospitals charging GHS 15,000 or more. For everyone else, healthcare means waiting until you\u2019re sick, queuing at an overcrowded facility, and hoping for the best.",
    ...
    items: [
      {
        ...
        body: "The healthcare system waits for you to get sick. We don\u2019t. BetterHealth exists to shift the paradigm from reactive treatment to proactive prevention \u2014 giving you the information to act before symptoms appear.",
      },
      {
        icon: "Eye",
        title: "Transparency Over Complexity",
        body: "No medical jargon. No confusing lab reports. No hidden fees. Everything we do is designed to be understood \u2014 from your biomarker results to your subscription price. If it\u2019s not clear, we haven\u2019t done our job.",
      },
      {
        icon: "Globe",
        title: "Access Over Exclusivity",
        body: "Comprehensive health screening shouldn\u2019t cost GHS 15,000 and require a referral. We\u2019ve built a platform that makes world-class lab testing accessible to every Ghanaian \u2014 not just the privileged few.",
      },
    ],
  },
  howWeWork: {
    headline: "We\u2019re a health technology company \u2014 not a lab.",
    body: [
      "BetterHealth doesn\u2019t run laboratories. We partner with accredited, established labs across Ghana to process your samples. Our role is the technology, the experience, and the intelligence layer on top.",
  ...
  roadmap: {
    ...
    intro: "BetterHealth launched in Ghana in 2026. But this is just the beginning. Here\u2019s what we\u2019re building toward:",
    milestones: [
...
export const pricingPage = {
  hero: {
    ...
    subheadline: "What would cost GHS 15,000+ at a private hospital is a fraction of that with BetterHealth. No referrals, no hidden fees, no surprises. All plans include your dashboard, results, and home collection.",
  },
  valueAnchor: "A comprehensive health screen at a private hospital in Accra costs between GHS 12,000 and GHS 18,000 \u2014 if they even offer all the tests. BetterHealth starts at GHS 8 per day.",
  plans: [
    {
      name: "Essential",
      ...
      popular: false,
      includes: [
        "67+ core biomarkers tested",
        "2 comprehensive screenings per year",
        "In-lab collection at partner facilities",
        "Digital health dashboard",
        "Organ system health overview",
        "Colour-coded results (green / amber / red)",
        "Plain-language biomarker explanations",
        "PDF report for your records",
        "Email & SMS results notifications",
        "Standard support",
      ],
      excludes: [
        "Home collection (available as GHS 50 add-on)",
    ...
    },
    {
      ...
      includes: [
        ...
        "100+ biomarkers tested (33 additional markers)",
        "2 comprehensive screenings per year",
        "Home collection included \u2014 no extra charge",
        "Biomarker trend tracking across screenings",
        "Personalized health recommendations",
        "Doctor\u2019s written report with each screening",
        "Priority results (48-hour turnaround)",
        "Full hormone panel",
        "Advanced cardiovascular markers (ApoB, Lp(a))",
        "Complete thyroid panel (TSH + T3 + T4)",
      ],
      excludes: [],
    ...
    },
    {
      ...
      includes: [
        ...
        "127+ biomarkers tested (the full panel)",
        "3 screenings per year (1 customised to your focus areas)",
        "Home collection included",
        "Doctor consultation call after each screening",
        "Personal nutritionist consultation (1 per year)",
        "Thyroid antibody testing (TPO + Thyroglobulin)",
        "Extended hormone panel (AMH, Prolactin)",
        "Quarterly re-testing option",
        "Family member discount (20% off additional members)",
  ...
  finePrint: "All plans are billed annually. Your subscription begins the day you sign up and renews automatically after 12 months. You can cancel at any time before renewal \u2014 no penalties, no questions. If you\u2019re not satisfied within the first 14 days, we\u2019ll refund you in full.",
  comparison: {
    ...
    rows: [
      ...
      { feature: "Home collection", essential: "Add-on (GHS 50)", complete: "Included", premium: "Included" },
      ...
      { feature: "Hormone panel", essential: "Basic (4)", complete: "Extended (8)", premium: "Complete (10)" },
      { feature: "Thyroid panel", essential: "TSH only", complete: "TSH + T3 + T4", premium: "All 5 + antibodies" },
  ...
  hospitalComparison: {
    ...
    rows: [
      { test: "Full Blood Count (CBC)", hospital: "GHS 150\u2013300", bh: "Included" },
      { test: "Lipid Panel (Cholesterol)", hospital: "GHS 200\u2013400", bh: "Included" },
      { test: "Liver Function Tests", hospital: "GHS 250\u2013500", bh: "Included" },
      { test: "Kidney Function Tests", hospital: "GHS 200\u2013450", bh: "Included" },
      { test: "Thyroid Panel (TSH, T3, T4)", hospital: "GHS 400\u2013800", bh: "Included" },
      { test: "HbA1c + Fasting Glucose", hospital: "GHS 150\u2013350", bh: "Included" },
      { test: "Hormone Panel", hospital: "GHS 500\u20131,500", bh: "Included" },
      { test: "Vitamin D + B12", hospital: "GHS 300\u2013600", bh: "Included" },
      { test: "Iron Studies", hospital: "GHS 200\u2013400", bh: "Included" },
      { test: "Estimated total", hospital: "GHS 12,000\u201318,000", bh: "GHS 4,957/year", isTotals: true },
    ],
    footnote: "Prices are estimates based on publicly available pricing from private diagnostic centres in Greater Accra (2025\u20132026). Individual facility prices may vary. Hospital costs typically do not include interpretation, dashboard access, or trend tracking.",
  },
  singleTests: {
    headline: "Not ready for a subscription? Start with a single test.",
    body: "BetterHealth also offers individual tests and disease-specific panels. No subscription required \u2014 just pay for what you need.",
    examples: [
      { name: "Malaria Test", price: "from GHS 35" },
      { name: "Diabetes Panel (Fasting Glucose + HbA1c + Insulin)", price: "from GHS 250" },
      { name: "Thyroid Panel (TSH + Free T3 + Free T4)", price: "from GHS 350" },
      { name: "Lipid Panel (Full cholesterol profile)", price: "from GHS 200" },
      { name: "Sickle Cell Screen", price: "from GHS 80" },
      { name: "Full Blood Count (CBC)", price: "from GHS 100" },
    ],
    cta: "Browse All Tests",
    note: "Individual test prices vary by location. Home collection is available as an add-on for GHS 50.",
  },
  faqs: [
    {
    ...
    },
    {
      ...
      a: "None. Your subscription price covers everything listed in your plan. The only optional add-on is home collection for Essential plan members (GHS 50 per visit). Complete and Premium plans include home collection at no extra charge.",
    },
  ],
  bottomCta: {
