// Original BetterHealth Africa research report (March 2026), published to the blog.
// Source: "The Heavy Price of Neglect: Deaths from Preventable Diseases and the
// State of Preventive Healthcare in Ghana." Survey of 351 Ghanaians, Jan–Mar 2026.
// All statistics are reproduced exactly from the source report; docx line-break
// artifacts were merged into clean paragraphs without altering any facts.
export default {
  slug: "preventable-diseases-preventive-healthcare-ghana",
  title:
  ...
  medicallyReviewedBy: "Dr. Delasy Kwame Gbekor and Dr. Afia Amponsah",
  image: "/og-image.png",
  imageAlt:
    "A research report on preventable diseases and preventive healthcare in Ghana.",
  tags: ["research", "preventive care", "Ghana", "NCDs", "health screening"],
  cluster: "screening",
  primaryKeyword: "preventive healthcare Ghana",
  readingMinutes: 16,
  body: [
    {
      type: "callout",
      title: "About this report",
      text: "This is original research by BetterHealth Africa, first prepared as a research report in March 2026. It draws on a primary survey of 351 Ghanaians conducted between January and March 2026, alongside data from the World Health Organization, the World Bank, and the Ghana Health Service. Authors: Dr. Delasy Kwame Gbekor, Dr. Afia Amponsah, Esther Forson, and Damzi.",
    },

    { type: "h2", id: "abstract", text: "Abstract" },
    {
      type: "p",
      text: "Preventive health services play a vital role in reducing the burden of non-communicable diseases (NCDs), improving quality of life, and promoting overall well-being (WHO, 2024). Yet Ghana faces a quiet but threatening public health crisis: many Ghanaians die each year from diseases that could have been detected and managed through routine preventive testing. Non-communicable diseases such as cardiovascular disease, diabetes, hypertension, and cancers now account for an estimated 43% of all deaths in the country (WHO, 2024), while infectious diseases including malaria and tuberculosis also claim lives that early detection and treatment could save.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "There is a quiet but deeply consequential crisis unfolding within Ghana's healthcare system. It is not always visible in dramatic headlines, yet it plays out daily in homes, hospitals, and communities across the country: people are dying from diseases that could have been detected early, managed effectively, or prevented entirely.",
    },
    {
      type: "p",
    ...
    { type: "h2", id: "literature-review", text: "2. Literature Review" },
    {
      type: "h3",
      id: "burden",
      text: "2.1 The burden of preventable disease deaths in Ghana",
    },
    {
      type: "p",
      text: "Ghana has made notable progress in expanding healthcare access since the introduction of the National Health Insurance Scheme (NHIS) in 2003 (National Health Insurance Authority, 2024). The country boasts a network of teaching hospitals, regional and district hospitals, health centres, and Community-based Health Planning and Services (CHPS) compounds reaching into rural areas. Life expectancy has risen from approximately 57 years in 2000 to around 64 years in 2024 (World Bank, 2024). Yet beneath this progress lies a structural imbalance: the system remains largely oriented toward treating illness after it occurs rather than preventing it.",
    },
    {
      type: "p",
    ...
    },
    {
      type: "h3",
      id: "disparities",
      text: "2.4 Geographic and demographic disparities",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "This study adopts a descriptive approach, focusing on understanding both the behaviour of individuals and the structure of the healthcare system within which they operate. Rather than relying solely on abstract statistics, it seeks to capture the lived realities of how Ghanaians think about their health and engage with healthcare services.",
    },
    {
      type: "p",
      text: "The primary data comes from a survey conducted between 16 January and 25 March 2026, involving 351 respondents. The survey explored how often individuals undergo medical testing, what motivates or discourages them, how confident they feel in understanding their results, and their openness to digital health solutions. It also assessed willingness to pay for preventive healthcare services.",
    },
    {
      type: "p",
      text: "To provide broader context, the study also draws on secondary data from the World Health Organization, the Ghana Health Service, and the World Bank. The analysis focuses on patterns in behaviour, supported by percentage distributions and scenario-based estimates that illustrate the potential impact of improved preventive care.",
    },
    ...
    {
      type: "image",
      src: "/blog/ghana-checkup-motivation.png",
      alt: "Survey chart showing what motivates Ghanaians to get health checkups, with most testing only in response to feeling unwell rather than routine prevention.",
      caption: "What motivates Ghanaians to get health checkups (351 responses).",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Despite these challenges, the data reveal a strong demand for preventive healthcare. An overwhelming 95.2% of respondents indicated that they are willing to pay for preventive health services, with 48.7% willing to pay less than GH₵100 per month and 34.5% willing to pay GH₵200 monthly. Only 4.8% stated that they would not pay at all. In addition, 76.3% of respondents reported being comfortable or very comfortable using digital platforms to access their health information, and 88.9% indicated that lifetime health tracking is extremely or very valuable.",
    },
    {
      type: "image",
    ...
    {
      type: "p",
      text: "When viewed alongside national health data, the implications become even more significant. Ghana records approximately 260,000–270,000 deaths annually (Ghana Health Service, 2024; WHO, 2024), with an estimated 110,000–120,000 deaths attributable to non-communicable diseases. NCDs are estimated to cost up to 6.77% of GDP (WHO, 2024; World Bank, 2024), translating to billions of dollars in lost productivity and healthcare expenses, while out-of-pocket health expenditure accounts for approximately 37% of total health spending.",
    },
    {
      type: "p",
      text: "Scenario-based estimates further illustrate the potential benefits of change. If even 20% of the currently non-testing population were to adopt regular screening, it could result in 50,000–60,000 additional individuals being screened annually. This could lead to the early detection of 15,000–18,000 cases of hypertension, preventing an estimated 2,000–3,000 strokes and heart attacks each year. Similarly, 3,000–5,000 previously undiagnosed cases of diabetes could be identified and managed earlier.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "The findings of this study challenge a common assumption that low uptake of preventive healthcare is driven by a lack of awareness or interest. On the contrary, the data show that 89.7% of individuals are interested in preventive testing and 95.2% are willing to pay for it. The issue is not demand; it is the absence of systems that enable people to act on that demand.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Consider a conservative scenario. If Ghana could shift just 20% of the currently non-testing population (the 71.5% who test only reactively or never) into annual screening, approximately 50,000–60,000 additional adults per year could be screened for hypertension, uncovering an estimated 15,000–18,000 previously undiagnosed cases (based on 30–35% prevalence and roughly 50% undiagnosed). Early management with affordable antihypertensive medication could prevent an estimated 2,000–3,000 strokes and heart attacks annually. Diabetes screening among the same population could identify 3,000–5,000 undiagnosed cases, enabling dietary and pharmaceutical intervention before complications develop. Cervical cancer screening expansion could detect pre-cancerous lesions in thousands of women, virtually eliminating progression to invasive disease. The survey data suggests this 20% shift is entirely achievable: with 89.7% expressing interest and 95.2% willing to pay, the raw demand far exceeds what even an optimistic policy shift would require.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Countries that have invested deliberately in preventive health demonstrate what is possible. Rwanda, despite a lower GDP per capita than Ghana, has achieved over 90% health insurance coverage and implemented community-based NCD screening through its extensive community health worker network, including a cervical cancer programme leveraging HPV self-sampling (Ministry of Health Rwanda, 2020). In South Korea, the National Health Insurance Corporation provides free biennial health screenings to all insured adults, including cancer screening; its five-year cancer survival rates are among the highest in the world, driven largely by early detection (NHIC, 2023). The NHS Health Check programme in the United Kingdom offers free cardiovascular risk assessments to adults aged 40–74 every five years, with modelling suggesting it prevents approximately 2,500 heart attacks and strokes annually (NHS England, 2024). Ghana does not need to replicate these systems wholesale, but the principle is universal: systematic, population-level preventive screening saves lives and money.",
    },

    { type: "h2", id: "conclusion", text: "6. Conclusion" },
    ...
    {
      type: "p",
      text: "The second is a story of latent demand and readiness for change. When 89.7% of Ghanaians say they want regular health testing, 95.2% are willing to pay for it, 88.9% see lifetime health tracking as valuable, and 76.3% are ready to engage through digital platforms, this is not a population that needs to be convinced. It is a population that is waiting for the opportunity.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Drawing on the survey findings, Ghana's health system context, and global evidence, this report proposes seven actionable recommendations.",
    },
    {
      type: "h3",
      id: "rec-1",
      text: "1. Establish a national preventive screening programme",
    },
    {
      type: "p",
    ...
    },
    {
      type: "h3",
      id: "rec-2",
      text: "2. Expand NHIS coverage to include preventive laboratory tests",
    },
    {
      type: "p",
      text: "The NHIS benefits package should be revised to include a defined set of annual preventive laboratory tests for all active members. This is perhaps the single most impactful policy change available. When the cost of testing is covered, the survey data strongly suggest uptake will follow: 95.2% of respondents are already willing to pay out of pocket, so NHIS coverage would remove whatever residual cost barrier exists. The additional cost can be offset by long-term savings from reduced emergency and late-stage care.",
    },
    {
      type: "h3",
      id: "rec-3",
      text: "3. Deploy digital health platforms for results tracking and health literacy",
    },
    {
      type: "p",
      text: "With 76.3% of respondents comfortable using digital platforms and 88.9% valuing lifetime health tracking, the conditions are ripe for a national digital health records initiative. A mobile-accessible platform that stores longitudinal test results, provides plain-language explanations of lab values, flags abnormal trends, and sends reminders for upcoming tests could address multiple gaps at once: the health-literacy deficit (where 35% lack confidence interpreting results), the follow-up failure (where 11.1% ignore 'normal' results), and the absence of continuous monitoring.",
    },
    {
      type: "h3",
      id: "rec-4",
      text: "4. Introduce employer wellness mandates",
    },
    {
      type: "p",
      text: "Ghana's Labour Act should be amended to require employers above a defined size threshold (e.g., 25+ employees) to provide or facilitate annual health screening for all workers. The survey finding that only 3.4% test due to employer requirements reveals an almost completely untapped channel. Employer-mandated screening is one of the most effective mechanisms for reaching working-age adults who would otherwise not test, and could be implemented through partnerships with accredited laboratories and digital health platforms, with tax incentives to offset employer costs.",
    },
    {
      type: "h3",
      id: "rec-5",
      text: "5. Scale community-based testing programmes",
    },
    {
      type: "p",
    ...
    },
    {
      type: "h3",
      id: "rec-6",
      text: "6. Launch targeted health literacy campaigns",
    },
    {
      type: "p",
    ...
    },
    {
      type: "h3",
      id: "rec-7",
      text: "7. Implement incentive-based engagement",
    },
    {
      type: "p",
...

    {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Not for the general adult population. The NHIS was designed mainly as a curative-care scheme and does not include routine annual blood work, cancer screening, or cardiovascular risk assessment for asymptomatic adults.",
        },
      ],
    },
    ...
    { type: "h2", id: "references", text: "8. References" },
    {
      ...
      items: [
        ...
        "Agyei-Mensah, S., & de-Graft Aikins, A. \"Epidemiological Transition and the Double Burden of Disease in Accra, Ghana.\" Journal of Urban Health, 87(5), 2010, pp. 879–897.",
        "Bosu, W.K. \"Epidemic of Hypertension in Ghana: A Systematic Review.\" BMC Public Health, 10(418), 2010.",
        "Ministry of Health, Ghana. National NCD Policy 2022–2026. Accra: MOH, 2022.",
        "Awoonor-Williams, J.K., et al. \"The Ghana Essential Health Interventions Programme.\" BMC Health Services Research, 13(Suppl 2), 2013.",
        "Republic of Rwanda, Ministry of Health. Rwanda Non-Communicable Diseases National Strategic Plan 2020–2025. Kigali: MOH Rwanda, 2020.",
        "National Health Insurance Corporation, South Korea. National Health Screening Programme Annual Report. Seoul: NHIC, 2023.",
        "National Health Service, United Kingdom. NHS Health Check Programme Standards. London: NHS England, 2024.",
        "World Health Organization. WHO Package of Essential Noncommunicable (PEN) Disease Interventions for Primary Health Care. Geneva: WHO, 2020.",
      ],
    },

    {
      type: "disclaimer",
      text: "This article reproduces a BetterHealth Africa research report for general education and public-health awareness. It is not medical advice and is not a substitute for diagnosis or treatment by a qualified healthcare professional. Statistics are drawn from the cited sources and an original survey of 351 Ghanaians conducted between January and March 2026.",
    },
  ],
};
