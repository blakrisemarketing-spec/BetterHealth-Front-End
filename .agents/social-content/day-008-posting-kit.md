...
Date: Tuesday, 2026-07-21
Theme: Fatty liver disease in plain English
Pillar: Tests Explained Simply
Primary job: Help people understand what fatty liver disease is, why it can be silent, what may cause it, and how a liver function test can be a useful starting point without implying one blood test explains the whole condition by itself.
Primary format: Instagram carousel
Primary CTA: Book a Liver Function Test

## Council Review Synthesis

This post is no longer only a marker explainer. It should start with a visual contrast people can understand immediately: fatty liver vs healthy liver. Then it should answer the practical questions a person would naturally ask next: what is it, how would I know, what causes it, what test helps, and what do the markers mean?
...
Do not present a liver function test as the only way to detect or confirm fatty liver disease. Do not imply normal liver function tests rule it out. Use careful language: "can give useful clues", "may help review", "often a useful place to begin", "needs context", "with symptoms, history, alcohol use, medicines, risk factors, imaging, and other tests where needed."

Avoid fear-heavy wording, liver detox language, cleansing claims, or certainty language.

Preferred framing:
- "How do you know if your liver is healthy?"
- "Fatty liver disease can be silent."
- "Many people do not feel symptoms early."
- "A liver function test can give useful clues."
- "The pattern matters more than one number."
- "Your result needs context before conclusions."

Statistic note:
- Do not publish the exact "380 million Africans" claim unless a reliable source is provided or verified.
- Safer hero support line: "Many people with fatty liver disease have no idea."
...
CTA: Save this and share it with someone who keeps saying they should check their liver.

Hashtags:
#BetterHealth #FattyLiver #LiverFunctionTest #LFT #BloodTest #GhanaHealth #HealthChecks
...
Book on BetterHealth.Africa

## Instagram Stories

Story 1 poll:
Have you ever checked your liver?
- Yes
- Not yet
...
Story 4:
A Liver Function Test can check markers like:
...
Visual job: make fatty liver disease visible without making the post feel like a scare campaign.

Suggested carousel visual direction:
- Slide 1 hero: fatty liver vs healthy liver comparison, organs fully visible, dramatic black gradient behind the hook, no overlay blocking the organs.
...
- vague organ decoration that does not explain the slide;
- implying a Liver Function Test alone confirms fatty liver disease;
- unverified prevalence claims on the artwork.

## Sources

- MedlinePlus, Liver Function Tests: https://medlineplus.gov/lab-tests/liver-function-tests/
- NIDDK, Definition & Facts of NAFLD/NASH: https://www.niddk.nih.gov/health-information/liver-disease/nafld-nash/definition-facts
- NIDDK, Diagnosis of NAFLD/NASH: https://www.niddk.nih.gov/health-information/liver-disease/nafld-nash/diagnosis
- Mayo Clinic, NAFLD Symptoms & Causes: https://www.mayoclinic.org/diseases-conditions/nonalcoholic-fatty-liver-disease/symptoms-causes/syc-20354567
